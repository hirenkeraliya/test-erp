...
<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Sales Collection Report" reportType="by Sales Date" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />

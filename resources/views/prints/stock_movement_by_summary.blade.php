...
<body class="arial-font-custom-report">
    ...
    @if(array_key_exists('products',$stockMovement) && array_key_exists('grand_total',$stockMovements))
    <table class="table table-bordered">
        ...
        @foreach ($stockMovement['products'] as $products)
        <tbody>
            ...
            <tr class="page-break-inside-avoid">
                ...
                <td class="text-right">{{ $inventoryUpdate['good_receive_note_quantity_in'] +
                    ...
                    $inventoryUpdate['stock_transfer_quantity_in'] }}</td>
                <td class="text-right">{{ $inventoryUpdate['good_receive_note_quantity_out'] + $inventoryUpdate['negative_stock_adjustment_quantity'] +
                    $inventoryUpdate['sale_quantity'] + $inventoryUpdate['order_quantity'] + $inventoryUpdate['stock_transfer_quantity_out'] }}</td>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr class="page-break-inside-avoid">
                ...
                <th class="text-right">{{ $stockMovements['grand_total']['total_opening_stock'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_good_receive_note_quantity_in'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_good_receive_note_quantity_out'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_stock_transfer_quantity_in'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_stock_transfer_quantity_out'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_purchase_order_quantity_in'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_purchase_order_quantity_out'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_positive_stock_adjustment_quantity'] }}
                </th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_negative_stock_adjustment_quantity'] }}
                </th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_sale_quantity'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_sale_return_quantity'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_order_quantity'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_order_return_quantity'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_good_receive_note_quantity_in'] +
                    ...
                    $stockMovements['grand_total']['total_stock_transfer_quantity_in'] +
                    $stockMovements['grand_total']['total_purchase_order_quantity_in'] }}</th>
                <th class="text-right">{{ $stockMovements['grand_total']['total_good_receive_note_quantity_out'] + $stockMovements['grand_total']['total_negative_stock_adjustment_quantity'] +
                ...
                <th class="text-right">{{ $stockMovements['grand_total']['total_closing_stock'] }}</th>
            </tr>
        </tbody>
    </table>
</body>

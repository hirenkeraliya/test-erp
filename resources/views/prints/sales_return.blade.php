...
<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Sale Return Report" reportType="" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />
    ...
    @foreach ($locationSales as $locationSale)
        ...
        <div>
            <table width=100%>
                <thead>
                    <tr>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="33%"> Receipt Before Return </th>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="34%"> Return </th>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="33%"> Receipt After Return </th>
                    </tr>
                </thead>
                <tbody>

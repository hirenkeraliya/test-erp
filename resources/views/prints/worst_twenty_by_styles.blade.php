...
<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Worst Twenty Report" reportType="By Style" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />
    ...
    @foreach($locationsSales as $locationSales)
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse($locationSales['styles'] as $style)

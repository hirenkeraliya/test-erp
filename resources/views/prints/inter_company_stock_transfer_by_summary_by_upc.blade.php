...
<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Inter Company Stock Transfer Report" reportType="By Summary By UPC" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />
    <div>

...
<head>
    ...
    <title>Goods Received Notes (By Brand)</title>
</head>
    ...
    <table>
        <tr>
            <td style="width: 550px;">
                ...
                <h4>
                    <strong>Goods Received Notes (By Brand)</strong>
                </h4>
        ...
        <tbody>
            @forelse($goodsReceivedNoteProducts as $goodsReceivedNoteProduct)
                <tr class="page-break-inside-avoid">
                    ...
                    <td class="mt-2 {{ $goodsReceivedNoteProduct['date'] === 'Total' ? 'text-bold' : ''}}">{{ $goodsReceivedNoteProduct['brand'] }}</td>

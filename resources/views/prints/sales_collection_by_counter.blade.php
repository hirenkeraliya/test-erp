...
<head>
    ...
    <title>Sales Collection by Counter</title>
</head>

<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Sales Collection Report" reportType="by Counter" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />

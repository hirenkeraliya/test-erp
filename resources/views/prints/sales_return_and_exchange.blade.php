...
<head>
    ...
    <title>Sales Exchange & Return Report</title>
...
<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Sales Exchange & Return Report" reportType="" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />
    ...
    @foreach ($locationSales as $locationSale)
        ...
        <div>
            <table>
                <thead>
                    <tr>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="33%"> Receipt Before Exchange/Return </th>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="34%"> Exchange/Return </th>
                        <th class="bottom-border text-center" style="border: 1px solid black;" width="33%"> Receipt After Exchange/Return </th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($locationSale['sale'] as $key => $sale)
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"> Product No.<br> Description </th>

...
<head>
    ...
    <title>Online Product Details</title>
...
<body class="arial-font-custom-report">
    ...
    <div>
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse ($products as $product)
                    <tr class="page-break-inside-avoid">
                        @foreach($columns as $column)
                            @if ($column === 'total_orders' || $column === 'total_order_returns')
            ...
            @if (collect($columns)->intersect(['total_orders', 'total_order_returns', 'units_sold', 'units_returned'])->isNotEmpty())
                <tr>
                    @foreach ($columns as $column)
                        @if ($column === 'total_orders')
                            <th class="text-right">@currencyFormat($grand_totals['total_amount_sold'])</th>
                        @elseif ($column === 'total_order_returns')

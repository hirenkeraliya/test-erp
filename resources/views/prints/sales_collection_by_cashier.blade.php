...
<head>
    ...
    <title>Sales Collection by Cashier</title>
</head>

<body class="arial-font-custom-report">
    <x-report-header :company="$company" reportName="Sales Collection Report" reportType="by Cashier" :filterBy="$filterBy" :dateRange="$dateRange" :date="$date"  />

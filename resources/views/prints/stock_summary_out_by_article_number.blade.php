...
<head>
    ...
    <title>Stock Transfer Out By Article Number</title>
    ...
    <table>
        <tr>
            <td style="width: 550px;">
                ...
                <h4>
                    <strong>Stock Transfer Out By Article Number</strong>
                </h4>
        ...
        <tbody>
            @forelse($stockTransferProducts as $stockTransferProduct)
                <tr class="page-break-inside-avoid">
                    ...
                    <td class="text-center mt-2 {{ $stockTransferProduct['product']['selection'] === 'Total' ? 'text-bold' : ''}}">{{ $stockTransferProduct['product']['location'] }}</td>

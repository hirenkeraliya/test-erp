...
<body class="arial-font-custom-report">
    ...
    <table class="table table-bordered bordered">
        ...
        <tbody>
            @forelse($saleThroughDataBySizes as $saleThroughDataBySize)
                <tr class="page-break-inside-avoid">
                    ...
                    <td class="text-right">
                        {{ $saleThroughDataBySize['received'] }}
                    </td>

                    <td class="text-right">
                        {{ $saleThroughDataBySize['sold'] }}
                    </td>

                    <td class="text-right">
                        {{ $saleThroughDataBySize['returned'] }}
                    </td>

                    <td class="text-right">
                        {{ (float) $saleThroughDataBySize['received'] - ((float) $saleThroughDataBySize['sold'] - (float) $saleThroughDataBySize['returned']) }}
                    </td>

                    <td class="text-right">
                        @if ((float) $saleThroughDataBySize['received'] === (float) 0)
                            0.00
                        @else
                            @truncateDecimal((((float) $saleThroughDataBySize['sold'] - (float) $saleThroughDataBySize['returned']) * 100) / (float) $saleThroughDataBySize['received'])
                        @endif
                    </td>
                </tr>
            @empty
            ...
            <tr class="page-break-inside-avoid text-bold">
                ...
                <td class="text-right">
                    <b>
                        {{ $saleThroughTotalDataBySizes['received'] }}
                    </b>
                </td>

                <td class="text-right">
                    <b>
                        {{ $saleThroughTotalDataBySizes['sold'] }}
                    </b>
                </td>

                <td class="text-right">
                    <b>
                        {{ $saleThroughTotalDataBySizes['returned'] }}
                    </b>
                </td>

                <td class="text-right">
                    <b>
                        {{ $saleThroughTotalDataBySizes['remaining'] }}
                    </b>
                </td>

                <td class="text-right">
                    <b>
                        {{ $saleThroughTotalDataBySizes['sale_through'] }}
                    </b>
                </td>
            </tr>
        </tbody>

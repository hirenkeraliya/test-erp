<template>
    ...
    <div
        v-if="state.displayTransitInventoryReportFilter"
        ...
        <template #extra-header-data="record">
            ...
            <p class="text-lg font-bold mr-1 sm:mr-2 float-left sm:float-none">
                <OutlinePrimaryButton
                    text="Filters"
                    class="text-sm shadow-md"
                    @click="state.displayTransitInventoryReportFilter = !state.displayTransitInventoryReportFilter"
                />
            </p>
        </template>
    </JTable>
...
const state = reactive({
    ...
    displayTransitInventoryReportFilter: false,
});
...
const exportCsvRecords = (params, columns) => {
    return exportRecords(
        'export-transit-inventory/',
        'transit_inventory.csv',
        params,
...
onMounted(() => {
    if (props.filterData.product_id != null) {
        ...
        state.isClear = true;
        state.displayTransitInventoryReportFilter = true;

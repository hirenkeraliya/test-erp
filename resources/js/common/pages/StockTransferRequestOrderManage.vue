...
const stockTransferForm = useForm({
    ...
    destination_location_id: props.selectedLocationId,
...
const getSelectedProductsStock = () => {
    const params = {
        ...
        source_location_id: stockTransferForm.source_location_id,
        source_type_id: stockTransferForm.source_type_id,
        destination_location_id: stockTransferForm.destination_location_id,
        destination_type_id: stockTransferForm.destination_type_id,
    };
...
const setDefaultDestinationId = () => {
    stockTransferForm.source_location_id = null;

    stockTransferForm.destination_location_id = state.selectedLocationId;
};
...
onMounted(() => {
    state.selectedLocationId = props.selectedLocationId;
    ...
    if (stockTransferForm.transfer_type === props.stockTransferTypes.request_order) {

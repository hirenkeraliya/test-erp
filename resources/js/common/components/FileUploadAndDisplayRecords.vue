    ...
    reader.onload = (e) => {
        ...
        axios.post(route(props.productUpcUrl), {
            ...
            for (const key in products) {
                ...
                matchedProductsList.push({ id: products[key].id, name: products[key].name, upc: products[key].upc, color_name : productColor, size_name : productSize, has_batch: hasBatch, product_variant_values: productVariantValues });
            ...
            records.forEach((record) => response.data.products.forEach((product) => {
                if (record.upc.toString() === product.upc.toString()) {                    
                    ...
                    const recordDetails = { id: product.id, name: product.name, compound_product_name: product.compound_product_name, upc: product.upc, color_name: productColor, size_name: productSize, has_batch: product.has_batch, product_variant_values: productVariantValues };

    ...
    reader.onload = (e) => {
        ...
        axios.post(route(props.productUpcUrl), {
            ...
            for (const key in products) {
                matchedProductsList.push({ id: products[key].id, name: products[key].name, upc: products[key].upc, color: products[key].color, size: products[key].size, derivatives: products[key].unit_of_measure ? products[key].unit_of_measure.derivatives : null, unit_of_measure: products[key].unit_of_measure });
            ...
            records.forEach((record) => response.data.products.forEach((product) => {
                if (record.upc.toString() === product.upc.toString()) {
                    const recordDetails = { id: product.id, name: product.name, compound_product_name: product.compound_product_name, upc: product.upc, color: product.color, size: product.size, derivatives: product.unit_of_measure ? product.unit_of_measure.derivatives : null, unit_of_measure: product.unit_of_measure };

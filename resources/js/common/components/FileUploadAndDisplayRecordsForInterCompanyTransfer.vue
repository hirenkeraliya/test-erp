...
const importRecords = (files) => {
    ...
    reader.onload = (e) => {
        ...
        axios.post(route(props.productUpcUrl), {
            ...
            showSuccessNotification('The products have been successfully selected from the file.');
            ...
            for (const key in products) {
                ...
                if (pageProps.value.product_variant) {
                    ...
                    productColor = products[key].color;
                    productSize = products[key].size;
                ...
                matchedProductsList.push({ id: products[key].id, name: products[key].name, upc: products[key].upc, color: productColor, size: productSize, product_variant_values: productVariantValues, derivatives: derivatives, unit_of_measure: unitOfMeasure });
            ...
            records.forEach((record) => response.data.products.forEach((product) => {
                if (record.upc.toString() === product.upc.toString()) {
                    ...
                    const recordDetails = { id: product.id, name: product.name, compound_product_name: product.compound_product_name, upc: product.upc, color: productColor, size: productSize, product_variant_values: productVariantValues, derivatives: derivatives, unit_of_measure: unitOfMeasure };

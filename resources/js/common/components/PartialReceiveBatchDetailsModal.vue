<template>
    ...
    >
        ...
        <ModalBody class="p-5 sm:p-10">
            ...
            >
                <div class="input-form col-span-8 sm:col-span-4 md:col-span-4 lg:col-span-3 xl:col-span-2">
                    <FormInput
                ...
                <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <JDatePicker
                        v-model:input-value="batchData.expiry_date"
                ...
                <div class="input-form col-span-8 sm:col-span-4 md:col-span-4 lg:col-span-3 xl:col-span-2">
                    <FormTextarea
                        v-model:input-value="batchData.notes"
                        input-name="notes"
                        input-label="Notes"
                    />
                </div>
...
const updateBatchDetails = () => {
    ...
    state.batch_details.forEach(item => {
        ...
        if (!item.expiry_date) {
            showErrorNotification('Batch Expiry Date is required.');
            state.isBatchError = true;
        }

        if (item.expiry_date < today) {
            showErrorNotification('Batch Expiry Date must be '+ today +' or later.');
            state.isBatchError = true;
        }
    });

                ...
                <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-4">
                    <div class="block sm:flex items-center">
                        ...
                        <OutlinePrimaryButton
                            text="Search"
                            class="shadow-md ml-0 sm:ml-2 flex flex-col sm:flex-row mt-2 sm:mt-8 text-sm mx-1"
...
const updateTheStock = (product, transferStock) => {
    ...
    product.stock = parseInt(transferStock);
...
const saveProducts = () => {
    emits('update:filter-advance-product-selection', state.products);

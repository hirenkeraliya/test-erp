<template>
    <div class="bg-slate-200 rounded-xl p-5">
        ...
        <div class="col-span-12 lg:col-span-12 md:col-span-12">
            ...
            >
                <div
                    v-for="(worstPromoter, index) in worstPromoters"
                    :key="index"
                    class="cursor-pointer"
                    @click="showPromoter(worstPromoter.id, worstPromoters.locations)"
                >
                    <div class="rounded-xl bg-white p-4 flex items-center justify-between h-full">
                        <div class="mr-2.5">
                            ...
                            <p class="mt-1 text-sm">
                                {{ truncateDecimal(worstPromoter.total_amount_sold) }}
                            </p>
                        </div>
                    </div>
                </div>

<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('super_admin.employee_groups.create')">
                <PrimaryButton
    ...
    <JTable
        :fetch-url="route('super_admin.employee_groups.fetch')"
        ...
        <template #action="data">
            <div class="flex justify-center items-center">
                <Link
                    ...
                    :href="route('super_admin.employee_groups.edit', data.item.id)"
                >

                ...
                >
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-0 sm:gap-6">
                            ...
                            <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
                                <FormSelectBox
                                    v-model:selected-record="employeeGroupForm.company_id"
                                    :records="companies"
                                    input-label="Company"
                        ...
                        <div class="mt-5">
                            <Link :href="route('super_admin.employee_groups.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveEmployeeGroup = () => {
    if (props.employeeGroup) {
        router.put(route('super_admin.employee_groups.update', props.employeeGroup.id), employeeGroupForm);
        return;
    }

    router.post(route('super_admin.employee_groups.store'), employeeGroupForm);
};
...
const getTitleText = () => {
    ...
    if (employeeGroupForm.purchase_limit_type_id === props.staticDetails.purchase_limit_by_amount) {
        return 'It will be consider total paid amounts. Set Zero To Unlimited Purchase';
    }

            ...
            <div class="intro-y box">
                <form @submit.prevent="saveRole">
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('super_admin.roles.index')">
                                <SecondaryButton
                                    text="Cancel"
                                    class="w-24 mr-1"
                                />
...
const saveRole = () => {
    ...
    if (props.role) {
        roleForm.post(route('super_admin.roles.update_roles_permissions', props.role.id));
        return;
    }

    roleForm.post(route('super_admin.roles.store'));
};

<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('super_admin.sales_channel.create')">
                <PrimaryButton
                    text="Add New Sales Channel"
                    class="shadow-md"
                />
            </Link>
        </div>
    ...
    <JTable
        :fetch-url="route('super_admin.sales_channel.fetch')"
        ...
        <template #action="data">
            <div class="flex justify-center items-center">
                ...
                <Link
                    ...
                    :href="route('super_admin.sales_channel.edit', data.item.id)"
                >
...
const refreshAccessToken = (saleChannelId) => {
...
const verifyUserAuthorization = () => {
    axios.post(route('super_admin.sales_channel.refresh_access_token', state.saleChannelId), superAdminForm)
        .then((response) => {
...
const updateStatus = (saleChannelId, status) => {
    router.post(route('super_admin.sales_channel.update_status', [saleChannelId, status ? 1 : 0]));
};
</script>

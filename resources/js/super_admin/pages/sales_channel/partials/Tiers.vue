<template>
    ...
    >
        <div class="input-form col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-5 xl:col-span-5">
            <FormSelectBox
        ...
        <div class="input-form col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-2 xl:col-span-2">
            <DeleteButton

<template>
    ...
    >
        <div
            ...
            @click="loginExternalLocation(externalCompany.id)"
        >
            <div class="flex">
...
const loginExternalLocation = (externalCompanyId) => {
    axios.get(route('warehouse_manager.external_logins.get_external_login_details', externalCompanyId))
        .then((response) => {

<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('warehouse_manager.barcode_prints.create')">
                <PrimaryButton
                    text="Print Barcode"
                    class="shadow-md"
                />
    ...
    <JTable
        :fetch-url="route('warehouse_manager.barcode_prints.fetch_barcodes')"
...
const addEntryToExportRecordTransaction = (fileName) => {
    axios.post(route('warehouse_manager.barcode_prints.download_pdf_entry'))
        .then(() => {
...
const fetchExportRecordsPendingStatuses = () => {
    ...
    axios.get(route('warehouse_manager.barcode_prints.get_pending_export_record_count'))
        .then(response => {

...
const additionalUpdateLocationType = (additionalLocationTypes) => {
    state.additionalTypeId = additionalLocationTypes;
...
const updateTransferType = (value) => {
    ...
    if (value === props.transferTypeOut || value === props.transferTypeIn) {
        state.additionalTypeId = props.staticLocationTypes.warehouse;
    }
};
...
const exportStockTransfer = () => {
    ...
    printReport(route('warehouse_manager.custom_reports.print_stock_transfer', state.parameters));
};

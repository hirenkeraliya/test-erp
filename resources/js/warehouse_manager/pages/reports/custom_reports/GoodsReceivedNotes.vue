...
const updateTheFilterBy = (filterBy) => {
    ...
    if (filterBy === props.goodsReceivedNoteFilterStaticDetails.byVendor) {
        axios.get(route('warehouse_manager.vendors.get_vendors_list'))
            .then((response) => {
...
const exportGoodsReceivedNotes = () => {
    ...
    printReport(route('warehouse_manager.custom_reports.print_goods_received_note', state.parameters));
};

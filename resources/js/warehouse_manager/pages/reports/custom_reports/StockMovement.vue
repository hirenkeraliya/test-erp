    ...
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        >
            <FileUploadAndDisplayRecords
                ...
                product-upc-url="warehouse_manager.products.get_matching_upc_products"
...
const exportStockMovement = () => {
    ...
    printReport(route('warehouse_manager.custom_reports.stock_movement_report_print', state.parameters));
};

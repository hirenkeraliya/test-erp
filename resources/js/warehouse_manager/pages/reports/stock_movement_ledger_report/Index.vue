<template>
    ...
    <div
        v-if="state.displayStockMovementFilter"
    ...
    <div v-if="state.parameters.product_id !== null">
        <JTable
            ...
            :fetch-url="route('warehouse_manager.stock_movement_ledger_report.fetch')"
            ...
            local-storage-key="warehouse-manager-stock-movement-ledger-reports-columns"
            ...
            <template #extra-header-data>
                <p class="text-lg font-bold mr-1 sm:mr-2 float-left sm:float-none">
                    <OutlinePrimaryButton
                        ...
                        @click="state.displayStockMovementFilter = !state.displayStockMovementFilter"
                    />
                </p>
            </template>
        </JTable>
...
const state = reactive({
    ...
    displayStockMovementFilter: true,
});

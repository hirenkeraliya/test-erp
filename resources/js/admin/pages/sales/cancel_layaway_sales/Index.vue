<template>
    ...
    <JTable
        ...
        :fetch-url="route('admin.cancel_layaway_sales.fetch')"
                    ...
                    >
                        <DropdownContent>
                            ...
                            <DropdownItem
                                ...
                                @click="printCancelLayawaySaleDigitalInvoice(record.item.id)"
                            >
...
import { ReceiptText, Info, List, Printer, Notebook, MoreHorizontal } from 'lucide-vue-next';
import { onMounted, reactive, computed } from 'vue';
import { route } from 'ziggy';
import CancelLayawaySaleDetails from '@adminPages/sales/cancel_layaway_sales/CancelLayawaySaleDetails.vue';
...
const showSaleDetailsModal = (saleId) => {
    ...
    axios.get(route('admin.cancel_layaway_sales.fetch_cancel_layaway_sale_items', saleId))
        .then((response) => {
...
const printCancelLayawaySale = (saleId) => {
    printReport(route('admin.cancel_layaway_sales.print_cancel_layaway_sale', saleId), props.exportPermission);
};
...
const printCancelLayawaySaleDigitalInvoice = (saleId) => {
    printReport(route('admin.cancel_layaway_sales.print_cancel_layaway_sale_digital_invoice', saleId), props.exportPermission);
};

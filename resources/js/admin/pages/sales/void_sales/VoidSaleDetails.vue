<template>
    ...
    >
        ...
        >
            <div
                v-if="voidSale.sale_items && voidSale.sale_items.length"
            ...
            >
                ...
                <JSimpleTable
                    :columns="columnsForVoidSaleItemDetails"
                    :records="voidSale.sale_items"
                    :allow-search="true"
                >
                    <template #upc="data">
                    ...
                    <tbody>
                        <tr>
                            <td
                                ...
                                class="text-right"
                            >
                                {{ 'Total: ' + displayAmountWithCurrencySymbol(getTotalOf(voidSale.sale_items, 'subtotal')) }}
                            </td>
                        </tr>
                        <tr v-if="voidSale.total_discount_amount > 0">
                            <td
                                colspan="8"
                                class="text-right"
                            >
                                {{ 'Discount: ' + displayAmountWithCurrencySymbol(voidSale.total_discount_amount) }}
                            </td>
                        </tr>
                        <tr v-if="voidSale.total_tax_amount > 0">
                            <td
                                colspan="8"
                                class="text-right"
                            >
                                {{ 'Tax: ' + displayAmountWithCurrencySymbol(voidSale.total_tax_amount) }}
                            </td>
                        </tr>
                        <tr>
                            <td
                                ...
                                class="text-right"
                            >
                                {{ 'Price Paid: ' + displayAmountWithCurrencySymbol(voidSale.total_amount_paid) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div
                v-if="voidSale.sale_discounts && voidSale.sale_discounts.length"
            ...
            >
                ...
                <JSimpleTable
                    :columns="columnsForVoidSaleDiscounts"
                    :records="voidSale.sale_discounts"
                    :allow-search="true"
                >
                ...
                <table class="table mt-2 intro-x font-medium bg-secondary">
                    <tbody>
                        <tr v-if="getTotalOf(voidSale.sale_discounts, 'amount') > 0">
                            <td
                                colspan="8"
                                class="text-right"
                            >
                                Total:
                                {{ displayAmountWithCurrencySymbol(getTotalOf(voidSale.sale_discounts, 'amount')) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div
                v-if="voidSale.payments && voidSale.payments.length"
                class="text-left items-center p-5 my-4 border border-slate-200/60"
            >
                <h3 class="font-medium text-base mr-auto">
                    Void Sale Payments
                ...
                <JSimpleTable
                    :columns="columnsForVoidSalePaymentDetails"
                    :records="voidSale.payments"
                    :allow-search="true"
                >
                    <template #amount="data">
                        {{ displayAmountWithCurrencySymbol(data.item.amount) }}
                ...
                <table class="table mt-2 intro-x font-medium bg-secondary">
                    <tbody>
                        <tr v-if="getTotalOf(voidSale.payments, 'amount') > 0">
                            <td
                                colspan="8"
                                class="text-right"
                            >
                                Total:
                                {{ displayAmountWithCurrencySymbol(getTotalOf(voidSale.payments, 'amount')) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div
                v-if="voidSale.sale_mismatches && voidSale.sale_mismatches.length"
                class="text-left items-center p-5 my-4 border border-slate-200/60"
            >
                <h3 class="font-medium text-base mr-auto">
                    Void Sale Mismatches
                </h3>

                <JSimpleTable
                    :columns="columnsForVoidSaleMismatches"
                    :records="voidSale.sale_mismatches"
                    :allow-search="true"
                />
            </div>
        </ModalBody>

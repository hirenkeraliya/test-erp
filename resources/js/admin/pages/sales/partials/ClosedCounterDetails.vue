                ...
                <TabPanels class="mt-3 overflow-x-auto">
                    ...
                    >
                        <CounterAttemptDetail
                            ...
                            print-counter-update-attempt-url="admin.closed_counters.export_closed_counter_attempts"
                        />
                    </TabPanel>
                    ...
                    >
                        <CounterTillDetail
                            ...
                            :counter-details="counterClosingDetails"
                            :counter-update-id="closingCounterId"
                            print-counter-update-till-url="admin.closed_counters.export_closed_counter_tills"
                            print-take-break-url="admin.closed_counters.export_take_break"
                            print-drawer-detail-url="admin.closed_counters.export_drawer_details"
                            print-track-offline-mode-url="admin.closed_counters.export_track_offline_mode"
                        />
                    </TabPanel>
                </TabPanels>
            </TabGroup>

    ...
    >
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-4">
            <FormSelectBox
                ...
                :validation-field-name="'variants.' + variantIndex + '.boxes.' + mainIndex + '.box_product_loyalty_points.' + index + '.membership_id'"
        ...
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-6 xl:col-span-4">
            <FormInput
                ...
                :validation-field-name="'variants.' + variantIndex + '.boxes.' + mainIndex + '.box_product_loyalty_points.' + index + '.points'"
...
const addNewTierDetails = (index) => {
    emits('add:new-tier-details', index);
};

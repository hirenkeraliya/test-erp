<template>
    ...
    <Tiers
        ...
        buy-input-title="The minimum spending is the sum of Buy items after applying Dream Price, Price Override."
        :buy-value-input-group-prefix="currencySymbol"
        max-value-input-label="Maximum Spend"
        max-value-input-title="The maximum spending is the sum of Buy items after applying Dream Price, Price Override."
    ...
    >
        <span class="flex">
            Buy “X” amount from the Buy Products list and get “X” {{ staticDetails.type_percentage === promotionForm.discount_type_id ? 'Percentage' : 'Flat' }} on one product from the uploaded get products list.
        </span>
    </InfoAlert>
</template>
<script setup>

<template>
    <div class="intro-y flex flex-col xl:flex-row -mx-3">
        <div class="w-full xl:w-1/2 px-3 mb-3 2xl:mb-0 border-b xl:border-b-0 border-r-0 xl:border-r">
            <ProductSelection
    ...
    >
        <span class="flex">
            Buy “X” quantities from the Buy Products list and get “X” quantities from the uploaded get products list for free.<br>
            Example: Buy 3 Shirts Get 1 Shirt Free -> 4th, 8th, 12th, ... will be free
        </span>
    </InfoAlert>
</template>
<script setup>

<template>
    ...
    >
        <span class="flex">
            Buy “X” quantity from the Buy Products list and get “X%” OFF on the uploaded get products list.
            Example: Buy 3 Shirts Get 10% on Pants -> For every 3 quantities of a shirt, 10% will be given to 1 pant
        </span>
    </InfoAlert>
</template>

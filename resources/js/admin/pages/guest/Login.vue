<template>
    ...
    <form @submit.prevent="loginForm.post(route('admin.login_user', { intent: props.intent, redirectBackTo: props.redirectBackTo }))">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                ...
                >
                    ...
                    <div class="intro-x flex text-slate-600 text-xs sm:text-sm mt-4">
                        ...
                        -->
                        <Link :href="route('admin.forgot_password')">
                            Forgot Password?
                        </Link>
                    </div>

            ...
            <div class="intro-y box">
                ...
                >
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('admin.cashier_groups.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveCashierGroup = () => {
    ...
    if (props.cashierGroup) {
        router.put(route('admin.cashier_groups.update', props.cashierGroup.id), cashierGroupForm);
        return;
    }

    router.post(route('admin.cashier_groups.store'), cashierGroupForm);
};

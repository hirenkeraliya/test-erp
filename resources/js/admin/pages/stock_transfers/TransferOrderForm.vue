                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="whitespace-nowrap">Quantity inside Package Type</th>
                                        ...
                                        >
                                            ...
                                            <td class="whitespace-nowrap">
                                                <input
                                                    v-if="stockTransferForm.transfer_items[itemIndex].product_id"
                                                    type="text"
                                                    class="form-control mt-[0px] w-[80px]"
...
const updatePackageTotalQuantity = (element, index) => {
    ...
    if (parseFloat(inputValue) !== parseFloat(stockTransferForm.transfer_items[index].transfer_stock)) {

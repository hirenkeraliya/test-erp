<template>
    ...
    <JTable
        ...
        :fetch-url="route('admin.products_ageing_report.fetch')"
...
const exportCsvRecords = (params, columns) => {
    ...
    return axios.get(route('admin.products_ageing_report.check_product_ageing_export_limit', params))
        .then((response) => {
...
const exportPDFRecords = (params, columns) => {
    params['export_columns'] = columns;
    printReport(route('admin.products_ageing_report.print_products_ageing_report', params), props.exportPermission);
};
...
const getBadgeData = () => {
    ...
    axios.get(route('admin.products_ageing_report.fetch_consolidate'), {

<template>
    ...
    <div class="mt-3">
        ...
        <div class="flex">
            ...
            <Tippy content="Quantity Remaining">
                <JBadge
    ...
    <JTable
        ...
        :fetch-url="route('admin.products_ageing_report.fetch_by_month_and_year')"
        ...
        local-storage-key="admin-products-ageing-reports-by-month-year-columns"
...
const exportCsvRecords = (params, columns) => {
    ...
    return axios.get(route('admin.products_ageing_report.check_product_ageing_by_month_year_export_limit', params))
        .then((response) => {
...
const exportPDFRecords = (params, columns) => {
    params['export_columns'] = columns;
    printReport(route('admin.products_ageing_report.print_products_ageing_report_by_month_and_year', params), props.exportPermission);
};
...
const getBadgeData = () => {
    ...
    axios.get(route('admin.products_ageing_report.fetch_consolidate_by_month_and_year'), {

<template>
    ...
    <JTable
        ...
        :fetch-url="route('admin.products_ageing_report.fetch_product_aging_by_upc')"
...
const exportCsvRecords = (params, columns) => {
    ...
    return axios.get(route('admin.products_ageing_report.check_product_ageing_export_limit_by_upc', params))
        .then((response) => {
...
const exportPDFRecords = (params, columns) => {
    params['export_columns'] = columns;
    printReport(route('admin.products_ageing_report.print_products_ageing_report_by_upc', params), props.exportPermission);
};
...
const getBadgeData = () => {
    ...
    axios.get(route('admin.products_ageing_report.fetch_consolidate_by_upc'), {

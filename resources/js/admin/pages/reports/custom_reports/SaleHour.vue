<template>
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        <div class="input-form col-span-12 sm:col-span-8 md:col-span-8 lg:col-span-8 xl:col-span-6">
            <div>
                <JDateTimePicker
                    :range-picker="true"
...
const printSaleHour = () => {
    ...
    printReport(route('admin.custom_reports.sale_hour_print', state.parameters));
};

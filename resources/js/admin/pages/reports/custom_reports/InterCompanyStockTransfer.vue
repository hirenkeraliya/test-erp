<template>
    ...
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        <div
            v-if="state.parameters.filter_by === interCompanyFilterStaticDetails.byMasterProduct"
            class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3"
        >
            <FormAjaxSelect
...
const exportInterCompanyStockTransfer = () => {
    ...
    printReport(route('admin.custom_reports.print_inter_company', state.parameters));
};
...
const updateExternalCompanyId = (externalCompanyId) => {
    ...
    axios.get(route('admin.external_locations.get_external_locations', externalCompanyId))
        .then((response) => {

<template>
    <PageTitle title="Worst Twenty Category Report" />
    ...
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3 ml-2">
            <FormSelectBox
                ...
                :records="worstTwentyReportTypes"
        ...
        <div
            v-if="state.parameters.report_type === worstTwentyReportStaticTypes.byAttributes"
        ...
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3 ml-2">
            <FormSelectBox
                ...
                :records="worstTwentyReportViewTypes"
        ...
        <div
            v-if="state.parameters.filter_by === worstTwentyFilterStaticDetails.byCounter"
            class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3"
        >
            <JMultiSelect
        ...
        <div
            v-if="state.parameters.filter_by === worstTwentyFilterStaticDetails.byCashier"
            class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3"
        >
            <JMultiSelect
                :disabled="0 === state.locationIds.length"
        ...
        <div
            v-if="state.parameters.report_type && state.parameters.report_type !== worstTwentyReportStaticTypes.byProducts && state.parameters.report_type !== worstTwentyReportStaticTypes.byMasterProduct"
            class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3"
        >
...
const clearAllLocations = () => {
    ...
    state.parameters.report_view_type = null;
...
const exportSalesCollection = () => {
    ...
    printReport(route('admin.custom_reports.print_worst_twenty', state.parameters));
};

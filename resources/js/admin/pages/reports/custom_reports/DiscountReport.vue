<template>
    ...
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3 ml-2">
            <FormSelectBox
                v-show="state.parameters.location_ids !== null && state.parameters.sale_discount_type === saleDiscountTypesStaticFilters.itemWise"
...
const exportSalesCollection = () => {
    ...
    printReport(route('admin.custom_reports.print_discount_report', state.parameters));
};

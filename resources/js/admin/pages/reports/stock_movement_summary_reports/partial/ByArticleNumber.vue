<template>
    <div>
        <h2 class="font-medium text-base mr-auto mt-6">
            Stock Movement Summary By Article Number
        </h2>
    </div>
...
import { exportRecords, printReport, stockMovementSummaryReportFilterValidationCheck } from '@commonServices/helper';
...
const exportCsvRecord = () => {
    return exportRecords(
        ...
        'stock-movement-product-article-number.csv',
        props.parameters,
...
const exportExcelRecord = () => {
    return exportRecords(
        'export-stock-movement-report/',
        'stock-movement-product-article-number.xlsx',
        props.parameters,
        props.exportPermission
    );
};

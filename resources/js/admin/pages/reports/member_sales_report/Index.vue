<template>
    ...
    <div
        v-if="state.displayMemberSalesReportFilter"
    ...
    >
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-5">
            ...
            <div>
                <FormSelectBox
                    v-model:selected-record="state.location"
                    :records="locations"
    ...
    <JTable
        ...
        :fetch-url="route('admin.member_sales_report.fetch')"
        ...
        local-storage-key="admin-member-sales-reports-columns"
        ...
        <template #extra-header-data>
            <p class="text-lg font-bold mr-1 sm:mr-2 float-left sm:float-none">
                <OutlinePrimaryButton
                    ...
                    @click="state.displayMemberSalesReportFilter = !state.displayMemberSalesReportFilter"
                />
            </p>
        </template>
    </JTable>
...
const state = reactive({
    ...
    displayMemberSalesReportFilter: false,
...
const showSaleDetailModal = (saleItemId) => {
    ...
    axios.get(route('admin.member_sales_report.fetch_member_report_sale_details', saleItemId))
        .then((response) => {

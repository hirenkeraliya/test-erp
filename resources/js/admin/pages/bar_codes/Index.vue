<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('admin.barcode_prints.create')">
                <PrimaryButton
                    text="Print Barcode"
                    class="shadow-md"
                />
    ...
    <JTable
        :fetch-url="route('admin.barcode_prints.fetch_barcodes')"
    ...
    >
        ...
        <template #print="record">
            ...
            <div
                v-if="record.item.status === staticExportRecordStatuses.inProgress"
                class="text-center"
            >
                <LoaderSvg />
            </div>
...
const addEntryToExportRecordTransaction = (fileName) => {
    axios.post(route('admin.barcode_prints.download_pdf_entry'))
        .then(() => {
...
const fetchExportRecordsPendingStatuses = () => {
    ...
    axios.get(route('admin.barcode_prints.get_pending_export_record_count'))
        .then(response => {
...
const exportStatusCheckInterval = 20000;

setInterval(fetchExportRecordsPendingStatuses, exportStatusCheckInterval);

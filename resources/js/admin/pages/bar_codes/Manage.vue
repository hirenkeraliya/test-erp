<template>
            ...
            <div class="intro-y box">
                    ...
                    <div class="grid grid-cols-12 gap-0 sm:gap-6">
                        ...
                        <div class="input-form col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-3 xl:col-span-3">
                            <FormSelectBox
                                ...
                                validation-field-name="product_price"
                                :required="true"
                            />
                ...
                <div class="w-full p-5">
                    ...
                    <div class="flex flex-row ml-auto">
                        <Link :href="route('admin.barcode_prints.index')">
                            <SecondaryButton
                                type="button"
                                text="Cancel"
                                class="w-24 mt-5"
    ...
    <AdvanceProductSelectionModalForBarcode
        ...
        product-article-search-url="admin.products.search_products_by_article_number"
...
import { removeLocalStorage, setLocalStorage, saveLocalStorage, isPrintRecords } from '@commonServices/helper';
...
const barcodePrint = () => {
    if (isPrintRecords(props.exportPermission)) {
        barcodePrintForm.watchEnabled = false;
        removeLocalStorage('barcode');
        ...
        if (barcodePrintForm.module_type === props.moduleTypeStaticEnum.manual) {
            if (state.barcodeCountThresholdForAsyncPrint === null ||
                ...
                axios.post(route('admin.barcode_prints.products_barcode_print_manual'), barcodePrintForm)
                    .then((response) => {
            ...
            if (state.barcodeCountThresholdForAsyncPrint && state.barcodeTotalQuantity > state.barcodeCountThresholdForAsyncPrint) {
                ...
                confirmDialogBox(message, () => {
                    barcodePrintForm.post(route('admin.barcode_prints.products_barcode_print'));
                });
            }
            return;
        }
...
onMounted(() => {
    setLocalStorage('barcode', barcodePrintForm);
...
const clearFormData = () => {
    barcodePrintForm.reset();
};

const checkSaveLocalStorage = () => {
    saveLocalStorage('barcode', barcodePrintForm);
};

watch(barcodePrintForm, () => {
    if (barcodePrintForm.watchEnabled) {

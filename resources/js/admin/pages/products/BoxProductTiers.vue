    ...
    >
        <div class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3">
            <FormSelectBox
                ...
                :validation-field-name="'boxes.' + index + '.package_type_id'"
                :required="true"
                @update:selected-record="updateTierBoxValueDetails($event, index, 'package_type_id')"
            />
        </div>

        <div class="input-form col-span-12 sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2">
            <FormInput
                class="mr-1"
                type="number"
                input-label="Units"
                ...
                :required="true"
                :validation-field-name="'boxes.' + index + '.units'"
        ...
        <div class="input-form col-span-12 sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2">
            <FormInput
                ...
                :validation-field-name="'boxes.' + index + '.retail_price'"
        ...
        <div class="input-form col-span-12 sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2">
            <FormInput
                ...
                :input-group-prefix="currencySymbol"
                :validation-field-name="'boxes.' + index + '.staff_price'"
...
import BoxProductMembershipLoyaltyPointTiers from '@adminPages/products/BoxProductMembershipLoyaltyPointTiers.vue';

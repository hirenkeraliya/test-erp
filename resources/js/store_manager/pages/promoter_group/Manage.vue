            ...
            <div class="intro-y box">
                ...
                >
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.promoter_groups.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const savePromoterGroups = () => {
    ...
    if (props.promoterGroup) {
        promoterGroupForm.put(route('store_manager.promoter_groups.update', props.promoterGroup.id));
        return;
    }

    promoterGroupForm.post(route('store_manager.promoter_groups.store'));
};

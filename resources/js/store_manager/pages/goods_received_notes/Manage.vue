            ...
            <div class="intro-y box">
                ...
                <form @submit.prevent="saveGoodsReceivedNote();">
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-0 sm:gap-6">
                            ...
                            <div class="input-form col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-6">
                                <FileUploadAndDisplayRecords
                                    ...
                                    product-upc-url="store_manager.products.get_matching_upc_inventory_products"
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.goods_received_notes.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const goodsReceivedNoteForm = useForm({
    ...
    uploaded_file: null,
    vendor_id: null,
    location_id: ObjectStorage.get('store-manager-store-id'),
});
...
const saveGoodsReceivedNote = () => {
    goodsReceivedNoteForm.post(route('store_manager.goods_received_notes.store'));
};
</script>

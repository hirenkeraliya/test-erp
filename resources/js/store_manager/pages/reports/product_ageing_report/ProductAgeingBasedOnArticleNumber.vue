q<template>
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.products_ageing_report.fetch_product_aging_by_article_number')"
...
const exportCsvRecords = (params, columns) => {
    ...
    return axios.get(route('store_manager.products_ageing_report.check_product_ageing_export_limit_by_article_number', params))
        .then((response) => {
...
const exportPDFRecords = (params, columns) => {
    params['export_columns'] = columns;
    printReport(route('store_manager.products_ageing_report.print_products_ageing_report_by_article_number', params), props.exportPermission);
};
...
const getBadgeData = () => {
    ...
    axios.get(route('store_manager.products_ageing_report.fetch_consolidate_by_article_number'), {

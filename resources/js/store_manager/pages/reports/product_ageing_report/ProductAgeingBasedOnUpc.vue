<template>
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.products_ageing_report.fetch_product_aging_by_upc')"
...
const exportCsvRecords = (params, columns) => {
    ...
    return axios.get(route('store_manager.products_ageing_report.check_product_ageing_export_limit_by_upc', params))
        .then((response) => {
            if (! response.data.exceeds_limit) {
                exportRecords(
                    'export-products-ageing-report-by-upc/',
                    'products_ageing_report_by_upc.csv',
                    params,
    ...
    return axios.get(route('store_manager.products_ageing_report.check_product_ageing_export_limit_by_upc', params))
        .then((response) => {
            if (! response.data.exceeds_limit) {
                exportRecords(
                    'export-products-ageing-report-by-upc/',
                    'products_ageing_report_by_upc.xlsx',
                    params,
                    props.exportPermission,
                    columns
                );
...
const exportPDFRecords = (params, columns) => {
    params['export_columns'] = columns;
    printReport(route('store_manager.products_ageing_report.print_products_ageing_report_by_upc', params), props.exportPermission);
};
...
const getBadgeData = () => {
    ...
    axios.get(route('store_manager.products_ageing_report.fetch_consolidate_by_upc'), {

<template>
    <BatchExpiryReport
        :fetch-url="route('store_manager.batch_expiry.fetch_batch_expiry')"
        ...
        local-storage-key="store-manager-batch-expiry-reports-columns"
...
import BatchExpiryReport from '@commonPages/BatchExpiryReport.vue';

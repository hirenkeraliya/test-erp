<template>
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.online_products_report.fetch')"
...
const exportPDFRecords = (params, columns) => {
    ...
    printReport(route('store_manager.online_products_report.print_online_products_report', params), props.exportPermission);
};
...
const refreshPage = () => {
    router.get(route('store_manager.online_products_report.index'));
};

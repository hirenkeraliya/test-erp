<template>
    ...
    <div class="grid grid-cols-12 gap-0 sm:gap-6">
        ...
        <div
            v-if="state.parameters.report_type && state.parameters.report_type !== worstTwentyReportStaticTypes.byProducts && state.parameters.report_type !== worstTwentyReportStaticTypes.byArticleNumber"
            class="input-form col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3"
        >
...
const exportSalesCollection = () => {
    ...
    printReport(route('store_manager.custom_reports.print_worst_twenty', state.parameters));
};

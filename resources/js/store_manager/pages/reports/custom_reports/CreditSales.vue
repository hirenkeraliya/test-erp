<template>
    <PageTitle title="Credit Sales Report" />
...
const exportCreditSales = () => {
    ...
    printReport(route('store_manager.custom_reports.credit_sales_print', state.parameters));
};

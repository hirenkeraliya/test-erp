<template>
    ...
    <div
        v-if="state.displayPaymentTypeFilter"
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.payment_type_report.fetch')"
        ...
        <template #extra-header-data="data">
            ...
            <p class="text-lg font-bold mr-1 sm:mr-2 float-left sm:float-none">
                <OutlinePrimaryButton
                    ...
                    @click="state.displayPaymentTypeFilter = !state.displayPaymentTypeFilter"
                />
            </p>
        </template>
    </JTable>
...
const state = reactive({
    ...
    counters: null,
    records: [],
    displayPaymentTypeFilter: false,
...
const showTransactionDetailsModal = (id) => {
    ...
    axios.get(route('store_manager.payment_type_report.fetch_transactions', state.parameters))
        .then((response) => {

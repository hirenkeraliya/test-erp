<template>
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.vouchers.fetch')"
        ...
        local-storage-key="store-manager-voucher-reports-columns"
    ...
    >
        <VoucherDetails
            ...
            :voucher-details-pdf-print="route('store_manager.vouchers.print_voucher_transaction_details', state.voucherId)"
...
import { displayAmountWithCurrencySymbol, displayAmountWithPercentageSymbol, exportRecords, currentDate } from '@commonServices/helper';
...
const showVoucherDetailsModal = (voucher) => {
    axios.get(route('store_manager.vouchers.fetch_voucher_transaction_details', voucher.id))
        .then((response) => {

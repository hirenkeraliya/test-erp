<template>
    ...
    >
        ...
        >
            <JTable
                :fetch-url="route('store_manager.promoter_commission.get_promoter_commission_details', promoterCommission.id)"
...
const exportPDFPromoterCommissionDetailsReport = () => {
    ...
    const url = route('store_manager.promoter_commission.print_promoter_commission_details', filters);

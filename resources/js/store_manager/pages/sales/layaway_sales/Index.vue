<template>
    ...
    <JTable
        ...
        :fetch-url="route('store_manager.layaway_sales.fetch')"
        ...
        local-storage-key="store-manager-layaway-sales-reports-columns"
...
import LayawaySaleDetails from '@storeManagerPages/sales/layaway_sales/LayawaySaleDetails.vue';
...
const showSaleDetailsModal = (saleId) => {
    state.layawaySale = [];
    axios.get(route('store_manager.layaway_sales.fetch_layaway_sale_items', saleId))
        .then((response) => {
...
const printLayawaySale = (saleId) => {
    printReport(route('store_manager.layaway_sales.print_layaway_sale', saleId), props.exportPermission);
};

const printSaleTaxInvoice = (saleId) => {
    printReport(route('store_manager.layaway_sales.print_sale_tax_invoice', saleId), props.exportPermission);
};

            ...
            <div class="intro-y box">
                ...
                >
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.employee_groups.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveEmployeeGroup = () => {
    ...
    if (props.employeeGroup) {
        router.put(route('store_manager.employee_groups.update', props.employeeGroup.id), employeeGroupForm);
        return;
    }

    router.post(route('store_manager.employee_groups.store'), employeeGroupForm);
};

            ...
            <div class="intro-y box">
                ...
                <form @submit.prevent="savePromoter();">
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.promoters.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const savePromoter = () => {
    ...
    if (props.promoter) {
        promoterForm.put(route('store_manager.promoters.update', props.promoter.id));
        return;
    }
    promoterForm.post(route('store_manager.promoters.store'));
};

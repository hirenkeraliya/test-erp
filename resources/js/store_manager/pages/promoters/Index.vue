<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('store_manager.promoters.create')">
                <PrimaryButton
    ...
    <JTable
        :fetch-url="route('store_manager.promoters.fetch')"
    ...
    >
        ...
        <template #status="record">
            {{ record.item.employee.status ? 'Active' : 'Inactive' }}
        </template>
        ...
        <template #action="data">
            <div class="flex justify-center items-center">
                <Link
                    ...
                    :href="route('store_manager.promoters.edit', data.item.id)"
                >
                ...
                <Link
                    class="flex items-center mr-3"
                    :href="route('store_manager.promoters.change_password', data.item.id)"
                >

<template>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <Link :href="route('store_manager.directors.create')">
                <PrimaryButton
    ...
    <JTable
        :fetch-url="route('store_manager.directors.fetch')"
        ...
        <template #action="data">
            <div class="flex justify-center items-center">
                <Link
                    ...
                    :href="route('store_manager.directors.edit', data.item.id)"
                >
                ...
                <Link
                    class="flex items-center mr-3"
                    :href="route('store_manager.directors.change_passcode', data.item.id)"
                >

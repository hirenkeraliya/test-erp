            ...
            <div class="intro-y box">
                ...
                <form @submit.prevent="saveDirector();">
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.directors.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveDirector = () => {
    ...
    if (props.director) {
        directorForm.put(route('store_manager.directors.update', props.director.id));
        return;
    }
    directorForm.post(route('store_manager.directors.store'));
};

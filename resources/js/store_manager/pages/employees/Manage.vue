            ...
            <div class="intro-y box">
                ...
                >
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.employees.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveEmployee = () => {
    ...
    if (props.employee) {
        employeeForm.post(route('store_manager.employees.update', props.employee.id));
        return;
    }

    router.post(route('store_manager.employees.store'), employeeForm);
};

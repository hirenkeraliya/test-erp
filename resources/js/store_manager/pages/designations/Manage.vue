            ...
            <div class="intro-y box">
                ...
                >
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.designations.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
const saveDesignation = () => {
    ...
    if (props.designation) {
        designationForm.put(route('store_manager.designations.update', props.designation.id));
        return;
    }

    designationForm.post(route('store_manager.designations.store'));
};

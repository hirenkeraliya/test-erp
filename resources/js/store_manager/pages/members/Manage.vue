            ...
            <div class="intro-y box">
                ...
                >
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-5">
                            <Link :href="route('store_manager.members.index')">
                                <SecondaryButton
                                    type="button"
                                    text="Cancel"
                                    class="w-24 mr-1"
...
import MultipleAddressTiers from '@storeManagerPages/members/MultipleAddressTiers.vue';
...
const memberForm = useForm({
    ...
    photo: null,
    photo_url: null,
    created_location_id: props.defaultStoreId,
    member_addresses: [
        {
            name: null,
            first_name: null,
...
const saveMember = () => {
    ...
    if (props.member) {
        memberForm.post(route('store_manager.members.update', props.member.id));
        return;
    }

    router.post(route('store_manager.members.store'), memberForm);
};

onMounted(() => {
    if (props.member) {
        Object.assign(memberForm, props.member);
        memberForm.photo_url = props.member.image_url ? props.member.image_url : null;
    }
});

...
/**
 * @extends Factory<CounterUpdate>
 */
class CounterUpdateFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'cashier_id' => fn () => Cashier::factory()->create()->id,
            'opening_balance' => random_int(1, 9999),
            'closing_balance' => random_int(1, 9999),
            'closed_at' => fake()->dateTime(),
            'mismatch_amount' => fake()->randomFloat(2, 0, 100),
            'amount_mismatch_reason' => fake()->text,

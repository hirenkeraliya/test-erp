...
use App\Domains\CashMovement\Resources\AdminCashMovementReportResource;
...
class CashMovementReportController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('reports/CashMovements', [
            ...
            'helpCenterMessages' => 'Show all the cash movements report with counter, location, authorizer person who perform this action, cash movement reason and amount offering advanced filters, search options, and seamless export capabilities for detailed analysis and insights.',
        ]);
    }
    ...
    public function fetchCashMovements(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->cashMovementQueries->getPaginatedListByIdFilterByText(
            $filterData,
        ...
        return [
            ...
            'data' => AdminCashMovementReportResource::collection($lengthAwarePaginator->getCollection()),
        ];
    }
    ...
    public function exportCashMovements(string $filename, Request $request): BinaryFileResponse
    {
        ...
        $cashMovements = $this->cashMovementQueries->getCashMovementListsForExport(
            $filterData,
            session('admin_company_id')
        );

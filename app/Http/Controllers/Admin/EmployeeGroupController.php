...
class EmployeeGroupController extends Controller
{
    ...
    public function fetchEmployeeGroups(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->employeeGroupQueries->listQuery($filterData, session('admin_company_id'));
    ...
    public function store(EmployeeGroupData $employeeGroupData, Request $request): RedirectResponse
    {
        ...
        $this->employeeGroupQueries->addNew($employeeGroupData, session('admin_company_id'), $user);

        return to_route('admin.employee_groups.index')->with('success', 'Employee group added successfully.');
    }

    public function edit(int $employeeGroupId): Response
    {
        $employeeGroup = $this->employeeGroupQueries->getById($employeeGroupId, session('admin_company_id'));
    ...
    {
        $this->employeeGroupQueries->update($employeeGroupData, $employeeGroupId, session('admin_company_id'));

        return to_route('admin.employee_groups.index')->with('success', 'Employee group updated successfully.');
    }

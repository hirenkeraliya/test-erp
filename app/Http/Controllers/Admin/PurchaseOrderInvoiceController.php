...
class PurchaseOrderInvoiceController extends Controller
{
    ...
    public function fetchPurchaseOrderInvoices(Request $request): array
    {
        ...
        return $purchaseOrderInvoiceService->fetchPurchaseOrderInvoices($filterData, session('admin_company_id'));
    }
    ...
    public function create(): Response
    {
        ...
        $purchaseOrders = $purchaseOrderQueries->getPurchaseOrderNumber($companyId);
    ...
    public function store(PurchaseOrderInvoiceData $purchaseOrderInvoiceData): RedirectResponse
    {
        $companyId = session('admin_company_id');
        $purchaseOrderQueries = resolve(PurchaseOrderQueries::class);
        $purchaseOrder = $purchaseOrderQueries->getByIdAndStatusAndOrderType(
            $companyId,
        ...
        try {
            ...
            return to_route('admin.purchase_order_invoices.index')->with(
                'success',
    ...
    public function edit(int $purchaseOrderInvoiceId, int $purchaseOrderId): Response
    {
        ...
        $purchaseOrderInvoice = $this->purchaseOrderInvoiceQueries->getById($purchaseOrderInvoiceId, $companyId);

        if ($purchaseOrderInvoice->status !== InvoiceStatuses::DRAFT->value) {
            throw new RedirectWithErrorException(
                'admin.purchase_order_invoices.index',
    ...
    public function updateInvoiceId(int $purchaseOrderFulfillmentId, int $purchaseOrderInvoiceId): RedirectResponse
    {
        ...
        return to_route(
            'admin.purchase_order_invoices.edit',
    ...
    public function sent(Request $request, int $purchaseOrderInvoiceId): RedirectResponse
    {
        ...
        $purchaseOrderInvoice = $this->purchaseOrderInvoiceQueries->getByIdForSent($purchaseOrderInvoiceId, $companyId);
    ...
    public function paid(Request $request, int $purchaseOrderInvoiceId): RedirectResponse
    {
        ...
        $purchaseOrderInvoice = $this->purchaseOrderInvoiceQueries->getByIdForPaid($purchaseOrderInvoiceId, $companyId);
    ...
    public function print(int $purchaseOrderInvoiceId): string
    {
        ...
        return $purchaseOrderPrintInvoiceService->printInvoice($purchaseOrderInvoiceId, session('admin_company_id'));
    }

...
use App\Domains\ProductAgeingReport\Resources\AdminProductsAgeingByMonthAndYearReportListResource;
use App\Domains\ProductAgeingReport\Resources\AdminProductsAgeingReportListResource;
...
class ProductAgeingReportController extends Controller
{
    ...
    public function fetchProductsAgeingReport(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->productAgeingQueries->getPaginatedProductsAgeingReport($filterData, $companyId);

        return [
            'total_records' => $lengthAwarePaginator->total(),
            'data' => AdminProductsAgeingReportListResource::collection($lengthAwarePaginator),
        ];
    }
    ...
    public function fetchProductsAgeingReportByMonthAndYear(Request $request): array
    {
        ...
        return [
            'total_records' => $lengthAwarePaginator->total(),
            'data' => AdminProductsAgeingByMonthAndYearReportListResource::collection($lengthAwarePaginator),
        ];
    }
    ...
    public function getLatestDataSync(): array
    {
        ...
        if (! $aggregateProcessTracker instanceof AggregateProcessTracker) {
            ...
            ProductAgeingTableUpdatesJob::dispatch(now()->format('Y-m-d'), $companyId)->onQueue(
        ...
        $aggregateProcessTrackerQueries->addNew($companyId, AggregateProcessTrackerModules::PRODUCT_AGEING->value);

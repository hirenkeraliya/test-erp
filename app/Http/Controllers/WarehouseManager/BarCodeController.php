...
class BarCodeController extends Controller
{
    ...
    public function productsBarcodePrint(BarcodeData $barcodeData, Request $request): RedirectResponse
    {
        ...
        return to_route('warehouse_manager.barcode_prints.index')
            ->with(
                'success',
    ...
    public function downloadPdfEntry(Request $request): void
    {
        ...
        try {
            ...
            $exportRecordTransactionQueries->addNew($user, session('warehouse_manager_selected_location_company_id'));

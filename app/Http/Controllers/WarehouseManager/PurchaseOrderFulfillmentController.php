...
class PurchaseOrderFulfillmentController extends Controller
{
    ...
    public function shippingDetails(int $purchaseOrderId): Response|RedirectResponse
    {
        ...
        $purchaseOrderFulfillmentService = resolve(PurchaseOrderFulfillmentService::class);
        $routeUrl = 'warehouse_manager.purchase_orders.index';
    ...
    public function shipped(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        $warehouseManager = $warehouseManagerQueries->loadEmployee($warehouseManager);
        ...
        try {
            $purchaseOrderFulfillmentService->shippedDeliveryOrder($purchaseOrderFulfillment, $warehouseManager);

            DB::commit();

            return to_route(
                'warehouse_manager.purchase_order_fulfillments.delivery_order',
    ...
    public function markAsReceived(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            $purchaseOrderFulfillmentService->markAsReceivedDeliveryOrder($purchaseOrderFulfillment, $warehouseManager);
    ...
    public function markAsCancel(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            $purchaseOrderFulfillmentService->markAsCancelDeliveryOrder($purchaseOrderFulfillment, $warehouseManager);
    ...
    public function markAsOpen(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            $purchaseOrderFulfillmentService->markAsOpen($purchaseOrderFulfillment, $warehouseManager);
    ...
    public function deliveryNote(int $purchaseOrderFulfillmentId): Response
    {
        ...
        $purchaseOrderFulfillmentService->checkDeliveryNote(
            ...
            'warehouse_manager.purchase_orders.index'
        );
    ...
    public function closed(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            ...
            return to_route('warehouse_manager.purchase_order_fulfillments.delivery_order', $purchaseOrder->id)->with(
                'success',
    ...
    public function discrepancy(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            $purchaseOrderFulfillmentService->deliveryOrderDiscrepancy($purchaseOrderFulfillment, $warehouseManager);
    ...
    public function addShippingDetails(
        ...
        try {
            ...
            return to_route('warehouse_manager.purchase_order_fulfillments.delivery_order', $purchaseOrderId)->with(
                'success',
    ...
    public function closeDiscrepancy(Request $request, int $purchaseOrderFulfillmentId): RedirectResponse
    {
        ...
        try {
            $purchaseOrderFulfillmentService->closeDeliveryOrderDiscrepancy(
                $purchaseOrderFulfillment,
                $warehouseManager
            );
    ...
    public function fetchPartiallyReceiveFulfillmentItems(int $partialReceiveId): array
    {
        ...
        $partialReceiveFulfillmentItem = $partiallyReceiveFulfillmentItemQueries->getPartiallyReceiveFulfillmentItems(
            $partialReceiveId
        );

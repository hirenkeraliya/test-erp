...
class StockMovementLedgerReportController extends Controller
{
    ...
    public function fetchStockMovementLedgerReport(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->inventoryUpdateQueries->getPaginatedStockMovementsOfAProductForLocationTypeWarehouse(
            $filterData,
        ...
        return [
            ...
            'data' => WarehouseManagerStockMovementLedgerReportListResource::collection(
    ...
    public function exportStockMovementLedger(string $filename, Request $request): BinaryFileResponse
    {
        ...
        $stockMovementLedgers = $this->inventoryUpdateQueries->getStockMovementsOfAProductForALocationForExportInWarehouseManagerPanel(
            $filterData,
            session('warehouse_manager_selected_location_id'),
        );

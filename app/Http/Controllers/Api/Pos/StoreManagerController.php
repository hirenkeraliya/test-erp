...
use App\Domains\StoreManager\Resources\PosStoreManagerListResource;
...
class StoreManagerController extends Controller
{
    ...
    public function getList(Request $request): array
    {
        ...
        $storeManagerRecord = $storeManageQueries->getStoreManagerListForPos($location->id, $afterUpdatedAt);

        return [
            'store_managers' => PosStoreManagerListResource::collection($storeManagerRecord),
        ];
    }
}

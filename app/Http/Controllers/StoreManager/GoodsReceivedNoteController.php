...
class GoodsReceivedNoteController extends Controller
{
    ...
    public function fetchGoodsReceivedNotes(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->goodsReceivedNoteQueries->listQueryForStoreManager(
            $filterData,
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('goods_received_notes/Manage', [
            'vendors' => $vendorQueries->getVendorByCompanyId(session('store_manager_selected_location_company_id')),
        ]);
    }
    ...
    public function store(GoodsReceivedNoteData $goodsReceivedNoteData, Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return to_route('store_manager.goods_received_notes.index')
    ...
    public function exportGoodReceivedNote(string $filename, Request $request): BinaryFileResponse
    {
        ...
        $goodsReceivedNotes = $this->goodsReceivedNoteQueries->getGoodeReceiveNotesExportForStoreManager(
            $filterData,
            session('store_manager_selected_location_company_id'),
            session('store_manager_selected_location_id')
        );

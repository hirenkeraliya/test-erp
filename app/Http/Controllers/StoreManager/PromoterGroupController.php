...
class PromoterGroupController extends Controller
{
    ...
    {
        return [
            'promoterGroups' => $this->promoterGroupQueries->getPromoterGroupByCompanyId(
    ...
    public function fetchPromoterGroups(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->promoterGroupQueries->listQuery(
            $filterData,
            session('store_manager_selected_location_company_id')
        );
    ...
    public function store(PromoterGroupData $promoterGroupData, Request $request): RedirectResponse
    {
        ...
        return to_route('store_manager.promoter_groups.index')->with(
            'success',
    ...
    {
        return Inertia::render('promoter_group/Manage', [
            'promoterGroup' => $this->promoterGroupQueries->getById(
                $promoterGroupId,
                session('store_manager_selected_location_company_id')
            ),
            'types' => SaleReturnOrVoidSaleReasonTypes::formattedForSelection(),

...
class OrderPickingListController extends Controller
{
    ...
    public function fetchOrderPickingLists(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->orderPickingListQueries->listQuery($filterData, $companyId);
    ...
    public function store(Request $request): void
    {
        ...
        $orderPickingListService->addOrderPickingList(
            (array) $request->get('order_ids'),
    ...
    public function printOrderPackaging(int $orderPickingListId): string
    {
        ...
        return $printOrderPickingListService->print(
            $orderPickingListId,
            session('store_manager_selected_location_company_id')
        );
    }

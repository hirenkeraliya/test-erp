...
class StockAdjustmentController extends Controller
{
    ...
    public function fetchItems(int $stockAdjustmentId): array
    {
        ...
        $stockAdjustmentItems = $stockAdjustmentItemQueries->getItemsByStockAdjustmentIdForStoreManager(
            $stockAdjustmentId,
            session('store_manager_selected_location_company_id'),
            session('store_manager_selected_location_id')
        );
    ...
    public function exportStockAdjustments(string $filename, Request $request): BinaryFileResponse
    {
        ...
        $stockAdjustments = $this->stockAdjustmentQueries->getStoreManagerStockAdjustmentsExport(
            $filterData,
            session('store_manager_selected_location_company_id'),
            session('store_manager_selected_location_id')
        );

...
class MemberReportController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('reports/members_report/Index', [
            ...
            'helpCenterMessages' => 'Display the active members report exclusively, with advanced filters, search options, and seamless export capabilities for in-depth analysis and insights.',
        ]);
    }
    ...
    public function fetchMembersReport(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->memberQueries->getPaginatedMemberReportForStoreManager(
            $filterData,
            $companyId,
            $locationId
        );
    ...
    public function fetchMembersDetails(Request $request): array
    {
        ...
        $lengthAwarePaginator = $this->memberQueries->fetchMemberDetails(
            $filterData,
            session('store_manager_selected_location_company_id')
        );
    ...
    public function exportMembersReport(string $filename, Request $request): BinaryFileResponse
    {
        ...
        $members = $this->memberQueries->getMembersReportForExportForStoreManager($filterData, $companyId, $locationId);

...
class AttributeCreateListener
{
    /**
     * Handle the event.
     */
    public function handle(AttributeCreateEvent $AttributeCreateEvent): void
    {
        ...
        $webhookUrls = [WebhookUrls::ATTRIBUTE_CREATE->value];
        ...
        Log::channel('e_commerce')->info('sale channel webhook attribute create started', [
            'start time of the webhook call for the attribute create' => Carbon::now()->format('Y-m-d H:i:s'),
        ...
        try {
            ...
            Log::channel('e_commerce')->error('sale channel webhook attribute create failed', [
        ...
        Log::channel('e_commerce')->info('sale channel webhook attribute create ended', [
            'end time of the webhook call for the attribute create' => Carbon::now()->format('Y-m-d H:i:s'),
            'attribute id: ' . $attribute->getKey(),
        ]);
    }
    ...
    public function retailPlanningAttributeSync(Attribute $attribute): void
    {
        ...
        $attributeRetailPlanningIntegrationService->manageAttribute(
            $attribute,
            IntegrationWebhookUrls::ATTRIBUTE_CREATE->value
        );
    }
}

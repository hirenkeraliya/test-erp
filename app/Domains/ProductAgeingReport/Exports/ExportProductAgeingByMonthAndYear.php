...
class ExportProductAgeingByMonthAndYear implements ExportRecordClassInterface
{
    ...
    public function fetch(ExportRecord $exportRecord, int $insertedRows, int $nextRecords): Collection
    {
        ...
        $productAgeings = $productAgeingQueries->exportProductAgeingByMonthAndYearRecords(
        ...
        return $productAgeingReportService->preparedDataByMonthAndYear($productAgeings, 1, $headerColumns);
    }
}

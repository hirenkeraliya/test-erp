...
class ProductAgeingReportByArticleNumberExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    public function collection(): Collection
    {
        ...
        return $productAgeingReportService->preparedDataByArticleNumber($this->productAgeings, $this->filteredColumns);
    }

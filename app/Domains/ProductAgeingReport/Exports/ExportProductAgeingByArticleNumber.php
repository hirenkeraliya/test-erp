...
class ExportProductAgeingByArticleNumber implements ExportRecordClassInterface
{
    ...
    public function fetch(ExportRecord $exportRecord, int $insertedRows, int $nextRecords): Collection
    {
        ...
        $productAgeings = $productAgeingQueries->exportProductAgeingRecordsForArticleNumber(
        ...
        return $productAgeingReportService->preparedDataByArticleNumber($productAgeings, $headerColumns);
    }
}

...
class ProductAgeingReportExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    public function collection(): Collection
    {
        ...
        return $productAgeingReportService->preparedData($this->products, $this->filteredColumns);
    }

...
class ExportProductAgeing implements ExportRecordClassInterface
{
    ...
    public function fetch(ExportRecord $exportRecord, int $insertedRows, int $nextRecords): Collection
    {
        ...
        $productAgeings = $productAgeingQueries->exportProductAgeingRecords(
        ...
        return $productAgeingReportService->preparedData($productAgeings, $headerColumns);
    }
}

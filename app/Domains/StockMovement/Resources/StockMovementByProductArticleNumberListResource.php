...
class StockMovementByProductArticleNumberListResource extends JsonResource
{
    /**
    ...
    {
        $stockMovementAggregate = $this->resource->toArray();

        return [
            'id' => $stockMovementAggregate['article_number'],
            'name' => $stockMovementAggregate['name'],
            'price' => $stockMovementAggregate['price'] ?? 0.00,
            'article_number' => $stockMovementAggregate['article_number'],
            ...
            'sold' => $stockMovementAggregate['sold'] ? CommonFunctions::numberFormat(
                (float) $stockMovementAggregate['sold']
            ) : 0,

...
class StockMovementSummaryServices
{
    public function printStockMovementDetails(array $filterData, int $companyId, array $getFilterLabels): string
    {
        ...
        $products = $sellThroughAggregateQueries->stockMovementForSummaryGet($filterData, $companyId);
        ...
        $locationColumns = ['Color Name', ...$locationName, 'Total'];

        return view('prints.stock_movement_report_by_summary', [

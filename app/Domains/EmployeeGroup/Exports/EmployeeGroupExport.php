...
class EmployeeGroupExport implements FromCollection, WithHeadings
{
    ...
    {
        return $this->employeeGroups->map(fn (EmployeeGroup $employeeGroup): array => [
    ...
    {
        return ['Name', 'Code', 'Purchase Limit Type', 'Item Purchase Limit', 'Limit Reset Type', 'Limit Reset'];
    }

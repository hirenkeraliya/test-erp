...
class AutomatedNotificationRequestStockJob implements ShouldQueueAfterCommit
{
    use Dispatchable;
    ...
    public function handle(): void
    {
        ...
        $message = 'Reminder for request stock';
        $textMessage = 'Reminder for request stock';
        ...
        try {
            ...
            Log::error('Automated Notification Request Stock Job Error', [

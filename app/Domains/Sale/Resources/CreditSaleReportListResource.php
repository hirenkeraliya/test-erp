...
class CreditSaleReportListResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        $storeManager = $sale->creditAuthorizer;
        ...
        return [
            ...
            'status' => $sale->status === SaleStatus::PENDING_CREDIT_SALE->value ? CreditAndLayawaySaleStatuses::getCaseName(
            ...
            'gross_sales' => CommonFunctions::numberFormat($sale->getGrossTotalForCreditSale()),
            'net_sales' => $sale->getCreditSaleTotalAmount(),

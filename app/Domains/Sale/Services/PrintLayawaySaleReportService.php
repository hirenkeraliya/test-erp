...
class PrintLayawaySaleReportService
{
    public function print(int $saleId, int $companyId, ?int $locationId): string
    {
        ...
        $layawaySaleDetails = $saleQueries->getLayawaySaleItemsByForPrint($saleId, $companyId, $locationId);
        ...
        return view('prints.layaway_sale_report', [

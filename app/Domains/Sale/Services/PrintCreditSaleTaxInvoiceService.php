...
class PrintCreditSaleTaxInvoiceService
{
    public function print(int $saleId, int $companyId, ?int $locationId = null): string
    {
        ...
        $sales = $saleQueries->getCreditSaleItemsByForPrint($saleId, $companyId, $locationId);
        ...
        return view('prints.credit_sale_tax_invoice', [
    ...
    private function getPreparedSaleItems(Collection $saleItems, ProductService $productService): array
    {
        return $saleItems->map(function ($saleItem) use ($productService): array {
            ...
            return [
                ...
                'total_pending_credit_amount' => $saleItem->calculateFinalSaleItemAmount() - $saleItem->getTotalPricePaid(),

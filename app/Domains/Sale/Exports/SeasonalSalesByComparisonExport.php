...
class SeasonalSalesByComparisonExport implements FromView, ShouldAutoSize
{
    ...
    {
        return view('prints.seasonal_sales_by_comparison', [
            ...
            'reportType' => SeasonalReportTypes::getFormattedCaseName(SeasonalReportTypes::BY_COMPARISON->value),

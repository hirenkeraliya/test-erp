...
class SaleReturnReportExport implements FromCollection, ShouldAutoSize, WithEvents
{
            ...
            foreach ($locationSale['sale'] as $sale) {
                ...
                foreach ($sale['sale_products'] as $key => $saleProduct) {
                    ...
                    $saleAndSaleReturnCollection->push([
                        ...
                        'column_7' => '',
                        'column_8' => $returnData ? $returnData['return_sale_happened_at'] : '',
                        'title_2' => $returnData ? $returnData['return_sale_offline_id'] : '',
                        'column_9' => $returnData ? 'UPC: ' . $returnData['upc'] : '',
                        'column_10' => $returnData ? 'Name: ' . $returnData['name'] . ' Reason: ' . $returnData['reason'] : '',
                        'column_11' => $returnData ? $returnData['quantity'] : '',
                        'column_12' => $returnData ? $returnData['price'] : '',
                        'column_13' => $sale['promoters'],
                        'column_14' => '',
                        'column_15' => $saleAndReturnData ? $saleAndReturnData['new_sale_happened_at'] : '',
                        'title_3' => $saleAndReturnData ? $saleAndReturnData['new_sale_offline_id'] : '',
                        'column_16' => $saleAndReturnData ? 'UPC: ' . $saleAndReturnData['upc'] : '',
                        'column_17' => $saleAndReturnData ? 'Name: ' . $saleAndReturnData['name'] : '',
                        'column_18' => $saleAndReturnData ? $saleAndReturnData['quantity'] : '',
                        'column_19' => $saleAndReturnData ? $saleAndReturnData['price'] : '',
                        'column_20' => $sale['promoters'],
                    ]);
                }

                if (
                    null !== $lastSectionKey && (is_countable($sale['new_sale_products']) ? count(
                        $sale['new_sale_products']
                    ) : 0) > 0

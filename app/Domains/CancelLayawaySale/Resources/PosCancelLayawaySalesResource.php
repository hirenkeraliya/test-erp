...
namespace App\Domains\CancelLayawaySale\Resources;
...
class PosCancelLayawaySalesResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        $storeManager = $cancelLayawaySale->storeManager;
        ...
        return [
            ...
            'reason' => $cancelLayawaySale->reason,
            'store_manager' => [
                'id' => $cancelLayawaySale->store_manager_id,

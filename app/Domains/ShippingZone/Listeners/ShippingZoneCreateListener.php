...
class ShippingZoneCreateListener
{
    /**
     * Handle the event.
     */
    public function handle(ShippingZoneCreateEvent $shippingZoneCreateEvent): void
    {
        $shippingZone = $shippingZoneCreateEvent->shippingZone;

        $saleChannelQueries = resolve(SaleChannelQueries::class);

        $webhookUrls = [WebhookUrls::SHIPPING_ZONE_CREATE->value];

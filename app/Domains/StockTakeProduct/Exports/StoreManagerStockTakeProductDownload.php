...
class StoreManagerStockTakeProductDownload implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    {
        return ['product_name', 'upc', 'article_number', 'size', 'color', 'unit_of_measure', 'submitted_stock'];
    }
}

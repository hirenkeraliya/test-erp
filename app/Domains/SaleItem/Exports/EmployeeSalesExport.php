...
class EmployeeSalesExport implements FromCollection, WithHeadings
{
    ...
    public function collection(): Collection
    {
        ...
        return $this->saleItems->map(function (SaleItem $saleItem) use ($productService): array {
            ...
            return $exportService->exportData($employeeSaleData, $this->filteredColumns);
        });
    }

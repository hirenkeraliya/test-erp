...
class ImportLocation implements ImportRecordClassInterface
{
    /**
     * @return string[]
     */
    public function validate(array $locationDetails, ImportRecord $importRecord): array
    {
        ...
        if ($locationType) {
            ...
            } elseif ($locationQueries->existsByNameAndTypeId(
            ...
            } elseif ($locationQueries->existsByCodeAndTypeId(
            ...
            if ($locationType === LocationTypes::STORE->value) {
                ...
                if (! array_key_exists('brands', $locationDetails) || ! $locationDetails['brands']) {
                    ...
                    $filterBrands = array_diff($brandNames, $brands);

                    if ([] !== $filterBrands) {
                        $validationErrors[] = 'We were unable to locate the specified brands ' . implode(
                            ',',
                            $filterBrands
                        ) . ' In our records, please verify the spelling or try searching for similar brands. If you have any trouble, please reach out to us. We will be happy to assist you.';
                    }
                }
            }
        }
    ...
    public function save(array $locationDetails, ImportRecord $importRecord): void
    {
        ...
        $locationQueries = resolve(LocationQueries::class);
        $locationQueries->addNew($locationData, $importRecord->company_id);
    }

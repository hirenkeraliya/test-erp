...
class StockTransferApiListResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        $updatedAt = $stockTransfer->updated_at;
        ...
        return [
            ...
            'transfer_type' => StockTransferTypes::getFormattedCaseName($stockTransfer->transfer_type),
            ...
            'updated_at' => $updatedAt->format($dateTimeStringFormat),
        ];
    }
}

...
class ImportColorGroup implements ImportRecordClassInterface
{
    public function validate(array $colorGroupDetails, ImportRecord $importRecord): array
    {
        ...
        if (! array_key_exists('name', $colorGroupDetails) || ! $colorGroupDetails['name']) {
            ...
            $validationErrors[] = 'Specified color group name is already assign';
        }

        if (! array_key_exists('code', $colorGroupDetails) && $colorGroupQueries->existsByCode(
    ...
    public function save(array $colorGroupDetails, ImportRecord $importRecord): void
    {
        ...
        $colorGroupQueries->addNew($colorGroupData, $importRecord->company_id);
    }

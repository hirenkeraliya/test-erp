...
class PromotionCreateListener
{
    /**
     * Handle the event.
     */
    public function handle(PromotionCreateEvent $promotionCreateEvent): void
    {
        $promotion = $promotionCreateEvent->promotion;
        ...
        $webhookUrls = [WebhookUrls::PROMOTION_CREATE->value];
        ...
        Log::channel('e_commerce')->info('sale channel webhook promotion create started', [
            'start time of the webhook call for the promotion create' => Carbon::now()->format('Y-m-d H:i:s'),
        ...
        try {
            ...
            Log::channel('e_commerce')->error('sale channel webhook promotion create failed', [
        ...
        Log::channel('e_commerce')->info('sale channel webhook promotions create ended', [
            'end time of the webhook call for the promotions create' => Carbon::now()->format('Y-m-d H:i:s'),
            'promotions id: ' . $promotion->getKey(),
        ]);
    }
}

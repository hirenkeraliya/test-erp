...
class ApplicationPromotionWithPromoCodeListResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        $preparedData = [
            ...
            'images' => static::getProductImages($promotion->regularProducts),
            'buy_product_images' => static::getProductImages($promotion->buyProducts),
            'get_product_images' => static::getProductImages($promotion->getProducts),
        ...
        if (! $promotion->is_automatic && $this->whenLoaded('saleItemDiscountPromotionPromoCodes')) {
            ...
            $preparedData['usage_type'] = $promotion->usage_type ? PromotionUsageTypes::getFormattedArrayForPos(
                $promotion->usage_type
            ) : null;
    ...
    public static function getProductImages(Collection $products): ?array
    {
        if ($products->isEmpty()) {
            return null;
        }

...
class EcommercePromotionListResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        $preparedData = [
            ...
            'sale_channels' => static::getPromotionSaleChannelId($promotion->saleChannels),
     ...
     * @return mixed[]|null
     */
    public static function getPromotionSaleChannelId(Collection $saleChannels): ?array
    {
        if ($saleChannels->isEmpty()) {
            return null;
        }

        return $saleChannels->map(fn ($saleChannel) => $saleChannel->id)->toArray();
    }

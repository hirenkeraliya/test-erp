...
class StockTakeExportForWarehouseManager implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    public function collection(): Collection
    {
        return $this->stockTakes->map(function (StockTake $stockTake): array {
            /** @var WarehouseManager $requestedManager */
            $requestedManager = $stockTake->requestedBy;
            /** @var WarehouseManager|null $submittedManager */
            ...
            $submittedEmployee = $submittedManager instanceof WarehouseManager ? $submittedManager->employee : null;
    ...
    public function headings(): array
    {
        return [
            'Stock Record Date',
            'Requested Warehouse Manager',
            'Warehouse',
            'Submitted Warehouse Manager',
            'Submitted At',
        ];
    }
}

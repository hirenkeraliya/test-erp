...
class PosBookingPaymentRefundResource extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        /** @var BookingPaymentRefund $bookingPaymentRefund */
        $bookingPaymentRefund = $bookingPayment->refund;

        /** @var PaymentType $paymentType */
        $paymentType = $bookingPaymentRefund->paymentType;
        ...
        return [
            ...
            'products' => $bookingPaymentProducts->map(function ($bookingPaymentProduct): array {
                ...
                return [
                    ...
                    'article_number' => (string) $product->article_number,
                    'size' => $product->size,
                    'color' => $product->color,
            ...
            'booking_payment_refunds' => $refunds instanceof Collection ? $refunds->map(

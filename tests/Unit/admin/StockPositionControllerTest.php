...
test(
    'It calls the adminStockPositionList method of the inventory queries class and returns proper response',
    function (): void {
        $companyId = 1;
        ...
        $stockPositionController = new StockPositionController();
        $response = $stockPositionController->fetchStockPositions(new Request($requestParameter));
...
test(
    'It calls the exportStockPositions method of the inventory queries class and returns proper response',
    function (): void {
        $companyId = 1;
        setCompanyIdInSession();
        ...
        $stockPositionController = new StockPositionController();
        $response = $stockPositionController->exportStockPositions('filename.csv', new Request($requestParameter));
...
test(
    'It calls the exportStockPositions method of the inventory and returns proper response',
    function (): void {
        $companyId = 1;
        setCompanyIdInSession();
...
test('it calls checkStockPositionExportLimit and returns proper response', function (): void {
    $companyId = 1;
    setCompanyIdInSession();
    ...
    $stockPositionController = new StockPositionController();
    $response = $stockPositionController->checkStockPositionExportLimit($request);

...
test(
    'It calls the List query method of the goods received note queries class and returns proper response',
    function (): void {
        $companyId = 1;
...
test('It calls the store method and returns a proper response', function (): void {
    ...
    $this->assertStringContainsString('admin/goods-received-notes', $redirectResponse->getTargetUrl());
...
test('It calls the getGoodsReceivedNoteProducts method and returns a proper response', function (): void {
    ...
    $goodsReceivedNoteController = new GoodsReceivedNoteController(new GoodsReceivedNoteQueries());
...
test('It calls the exportGoodReceivedNote method and returns a proper response', function (): void {
    $companyId = 1;
    ...
    $goodsReceivedNoteQueries = $this->mock(GoodsReceivedNoteQueries::class, function ($mock) use (
        ...
        $mock->shouldReceive('getGoodeReceiveNotesExport')
            ->once()
            ->with($requestParameter, $companyId)

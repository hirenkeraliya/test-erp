...
test(
    'It calls the get paginated booking payment lists method of the booking payment queries class and returns proper response',
    function (): void {
        $companyId = 1;
        ...
        $bookingPaymentQueries = $this->mock(BookingPaymentQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getPaginatedBookingPaymentList')
            ->once()
...
test(
    ...
    function (): void {
        ...
        $bookingPaymentQueries = $this->mock(BookingPaymentQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getBookingPaymentForExport')
            ->once()
            ->with($requestParameter, $companyId)

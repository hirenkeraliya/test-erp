...
test(
    'It calls the getPaginatedListByIdFilterByText method of the CashMovementQueries class and returns proper response',
    function (): void {
        $companyId = 1;
        ...
        $cashMovementQueries = $this->mock(CashMovementQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getPaginatedListByIdFilterByText')
                ->once()
...
test(
    ...
    function (): void {
        ...
        $cashMovementQueries = $this->mock(CashMovementQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getCashMovementListsForExport')
                ->once()
                ->with($requestParameter, $companyId)

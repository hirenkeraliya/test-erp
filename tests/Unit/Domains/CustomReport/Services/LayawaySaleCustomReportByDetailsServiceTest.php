...
use App\Domains\Sale\Services\LayawaySaleCustomReportByDetailsService;
...
it('export function exports sales data by details and item to expected format', function (): void {
    ...
    $layawaySaleCustomReportByDetailsService = new LayawaySaleCustomReportByDetailsService();
    $result = $layawaySaleCustomReportByDetailsService->export($filterData, $company->id, 'demo.csv');

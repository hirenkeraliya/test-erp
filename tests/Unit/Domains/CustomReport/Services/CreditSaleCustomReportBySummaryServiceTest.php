...
use App\Domains\Sale\Services\CreditSaleCustomReportBySummaryService;
...
it('export function exports sales data by summary and item to expected format', function (): void {
    ...
    $creditSaleCustomReportBySummaryService = new CreditSaleCustomReportBySummaryService();
    $result = $creditSaleCustomReportBySummaryService->export($filterData, $company->id, 'demo.csv');

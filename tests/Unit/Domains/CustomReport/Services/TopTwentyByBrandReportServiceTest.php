...
use App\Domains\Sale\Services\TopTwentyByBrandReportService;
...
it('exports the top twenty brand report for a given company as an Excel file', function (): void {
    ...
    $filterData = [
        ...
        'cashier_ids' => [],
        'counter_ids' => [],
        'report_type' => [TopTwentyReportTypes::BY_BRANDS->value],
    ...
    $topTwentyByBrandReportService = resolve(TopTwentyByBrandReportService::class);
    $result = $topTwentyByBrandReportService->export($company->id, $filterData, 'demo.xlsx');

    expect($result)->toBeInstanceOf(BinaryFileResponse::class);
});

it('prints the top twenty brand report for a given company and returns a string', function (): void {
    $company = Company::factory()->make([
        'id' => 1,
        'default_country_id' => 1,
    ]);
    ...
    $topTwentyByBrandReportService = resolve(TopTwentyByBrandReportService::class);
    $response = $topTwentyByBrandReportService->print($company->id, $filterData);

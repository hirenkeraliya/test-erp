...
use App\Domains\Sale\Services\TopTwentyByCategoryReportService;
...
it('exports the top twenty category report for a given company as an Excel file', function (): void {
    ...
    $topTwentyByCategoryReportService = resolve(TopTwentyByCategoryReportService::class);
    $result = $topTwentyByCategoryReportService->export($company->id, $filterData, 'demo.xlsx');

    expect($result)->toBeInstanceOf(BinaryFileResponse::class);
});

it('prints the top twenty category report for a given company and returns a string', function (): void {
    $company = Company::factory()->make([
        'id' => 1,
        'default_country_id' => 1,
    ]);
    ...
    $topTwentyByCategoryReportService = resolve(TopTwentyByCategoryReportService::class);
    $response = $topTwentyByCategoryReportService->print($company->id, $filterData);

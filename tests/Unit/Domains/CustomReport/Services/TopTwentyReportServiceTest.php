...
it('exports the top twenty category report for a given company as an Excel file', function (): void {
    ...
    $this->mock(TopTwentyAggregateDataQueries::class, function ($mock): void {
    ...
    $result = $topTwentyReportService->exportTopTwenty($company->id, $filterData, 'demo.xlsx');
...
it('prints the top twenty category report for a given company and returns a string', function (): void {
    ...
    $topTwentyReportService = resolve(TopTwentyReportService::class);
    $response = $topTwentyReportService->print($company->id, $filterData);

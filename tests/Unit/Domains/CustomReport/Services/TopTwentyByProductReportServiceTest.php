...
use App\Domains\Sale\Services\TopTwentyByProductReportService;
...
it('exports the top twenty product report for a given company as an Excel file', function (): void {
    ...
    $filterData = [
        ...
        'cashier_ids' => [],
        'counter_ids' => [],
        'report_type' => [TopTwentyReportTypes::BY_PRODUCTS->value],
    ...
    $topTwentyByProductReportService = resolve(TopTwentyByProductReportService::class);
    $result = $topTwentyByProductReportService->export($company->id, $filterData, 'demo.xlsx');

    expect($result)->toBeInstanceOf(BinaryFileResponse::class);
});

it('prints the top twenty product report for a given company and returns a string', function (): void {
    $company = Company::factory()->make([
        'id' => 1,
        'default_country_id' => 1,
    ]);
    ...
    $topTwentyByProductReportService = resolve(TopTwentyByProductReportService::class);
    $response = $topTwentyByProductReportService->print($company->id, $filterData);

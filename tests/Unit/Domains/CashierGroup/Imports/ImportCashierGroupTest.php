...
test(
    ...
    function (): void {
        ...
        $importCashierGroup = new ImportCashierGroup();
        $redirectResponse = $importCashierGroup->validate($cashierGroupData, $importRecord);
...
test('It calls addNew method to store cashier group details', function (): void {
    $companyId = 1;
    ...
    $importCashierGroup = new ImportCashierGroup();
    $importCashierGroup->save($cashierGroupRecord, $importRecord);
});
...
test('validate import Cashier Group Import Columns', function (): void {
    ...
    $importCashierGroup = new ImportCashierGroup();
    $response = $importCashierGroup->validateColumns($requiredHeaderColumns, [], 1);

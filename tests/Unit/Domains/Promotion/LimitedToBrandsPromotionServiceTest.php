...
beforeEach(function (): void {
    $this->limitedToBrandsPromotionService = new LimitedToBrandsPromotionService();
    ...
    $this->promotion = Promotion::factory()->make([
        'id' => 1,
        'company_id' => 1,
        'name' => 'Item wise limited to brands',
        'promotion_applicable_type_id' => 2,
        'discount_type_id' => 1,
        'item_wise_promotion_type_id' => 12,
        'timeframe_type_id' => 1,
        'percentage' => 0,
        'flat_amount' => 10.2,
...
test(
    ...
    function (): void {
        ...
        $this->limitedToBrandsPromotionService->checkForApplicability(
...
test(
    ...
    function (): void {
        ...
        $mock = $this->createPartialMock(
            LimitedToBrandsPromotionService::class,
...
test(
    ...
    function ($itemTotal, $percentage): void {
        ...
        $response = $this->limitedToBrandsPromotionService
...
test('getItemDiscountAmount method return 0 when not set item_discount_amount in cart', function (): void {
    ...
    $response = $this->limitedToBrandsPromotionService->getItemDiscountAmount($cartItem);

...
beforeEach(function (): void {
    $this->cartWideAsPerAmountPromotionService = new CartWideAsPerAmountPromotionService();
...
test(
    ...
    function (): void {
        ...
        $mock = $this->createPartialMock(
            CartWideAsPerAmountPromotionService::class,
...
test(
    ...
    function (): void {
        ...
        $mock = $this->createPartialMock(CartWideAsPerAmountPromotionService::class, ['getCartFlatDiscountAmount']);
...
test('getCartFlatDiscountAmount method calls same class methods as expected', function (): void {
    $mock = $this->createPartialMock(CartWideAsPerAmountPromotionService::class, ['getPromotionTierValue']);
...
test(
    ...
    function (): void {
        ...
        $cartWideAsPerAmountPromotionService = new CartWideAsPerAmountPromotionService();
    ...
    HttpException::class,
    'Cart Wide automatic discount is applied but it is not applicable as per our records. Subtotal: 1'
);
...
test('getPromotionTierValue method returns response as expected', function ($cartSubTotal, $getValue): void {
    ...
    $response = $this->cartWideAsPerAmountPromotionService->getCartFlatDiscountAmount($cartSubTotal, $this->promotion);
...
test(
    ...
    function (): void {
        ...
        $this->checkSaleDetailsService->saleData = new SaleData(...$this->saleDetails);
        $response = $this->cartWideAsPerAmountPromotionService->getCartDiscountAmount($this->checkSaleDetailsService);

...
beforeEach(function (): void {
    $this->limitedToCategoriesPromotionService = new LimitedToCategoriesPromotionService();
...
test(
    'checkForApplicability method sets the saleMismatches when none of the product categories are in the promotion categories',
    function (): void {
        ...
        $this->product->categories = collect($this->category);

        $this->promotion->categories = collect(new Category());
        ...
        $this->limitedToCategoriesPromotionService->checkForApplicability(
...
test(
    ...
    function (): void {
        ...
        $this->promotion->categories = collect([$this->category]);
...
test(
    ...
    function (): void {
        ...
        $mock = $this->createPartialMock(
            LimitedToCategoriesPromotionService::class,
...
test(
    ...
    function ($itemTotal, $percentage): void {
        ...
        $response = $this->limitedToCategoriesPromotionService
...
test('getItemDiscountAmount method return 0 when not set item_discount_amount in cart', function (): void {
    ...
    $response = $this->limitedToCategoriesPromotionService->getItemDiscountAmount($cartItem);

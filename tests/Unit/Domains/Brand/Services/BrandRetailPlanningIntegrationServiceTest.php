...
beforeEach(function (): void {
    ...
    $this->integration->integrationWebhookUrls = IntegrationWebhookUrl::factory(2)->make([
        ...
        'webhook_url_type_id' => IntegrationWebhookUrls::BRAND_CREATE->value,
    ]);

    $this->brandRetailPlanningIntegrationService = new BrandRetailPlanningIntegrationService();
});

test('it sends a request to the retail planning API for brand creation', function (): void {
    Http::fake();
    ...
    $this->brandRetailPlanningIntegrationService->manageBrand($brand, IntegrationWebhookUrls::BRAND_CREATE->value);

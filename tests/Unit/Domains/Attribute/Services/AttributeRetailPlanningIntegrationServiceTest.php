...
beforeEach(function (): void {
    ...
    $this->integration->integrationWebhookUrls = IntegrationWebhookUrl::factory(2)->make([
        ...
        'webhook_url_type_id' => IntegrationWebhookUrls::ATTRIBUTE_CREATE->value,
    ]);

    $this->attributeRetailPlanningIntegrationService = new AttributeRetailPlanningIntegrationService();
});

test('it sends a request to the retail planning API for attribute creation', function (): void {
    Http::fake();
    ...
    $this->attributeRetailPlanningIntegrationService->manageAttribute(
        $attribute,

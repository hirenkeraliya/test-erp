...
test(
    ...
    function (): void {
        $stockTransferByDocumentReportService = new StockTransferByDocumentReportService();
        ...
        $response = $stockTransferByDocumentReportService->exportStockTransferReportByDocumentExport(
            1,
            [
                'location_ids' => [],
                'status_type' => null,

...
beforeEach(function (): void {
    ...
    $this->integration->integrationWebhookUrls = IntegrationWebhookUrl::factory(2)->make([
        ...
        'webhook_url_type_id' => IntegrationWebhookUrls::REGION_CREATE->value,
    ]);

    $this->regionRetailPlanningIntegrationService = new RegionRetailPlanningIntegrationService();
});

test('it sends a request to the retail planning API for region creation', function (): void {
    Http::fake();
    ...
    $this->regionRetailPlanningIntegrationService->manageRegion(
        $region,

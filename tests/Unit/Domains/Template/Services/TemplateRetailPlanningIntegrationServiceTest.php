...
beforeEach(function (): void {
    ...
    $this->integration->integrationWebhookUrls = IntegrationWebhookUrl::factory(2)->make([
        ...
        'webhook_url_type_id' => IntegrationWebhookUrls::TEMPLATE_CREATE->value,
    ]);

    $this->templateRetailPlanningIntegrationService = new TemplateRetailPlanningIntegrationService();
});

test('it sends a request to the retail planning API for template creation', function (): void {
    Http::fake();
    ...
    $this->templateRetailPlanningIntegrationService->manageTemplate(
        $template,

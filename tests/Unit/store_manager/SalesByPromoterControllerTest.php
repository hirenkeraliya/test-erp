...
test(
    'It calls the get paginated store manager sales by promoters method of the promoter queries class and returns proper response',
    function (): void {
        $companyId = 1;
        setStoreIdInSession();
        ...
        $saleQueries = $this->mock(PromoterQueries::class, function ($mock) use (
            $requestParameter,
            $companyId
        ): void {
        ...
        $salesByPromoterController = new SalesByPromoterController($saleQueries);

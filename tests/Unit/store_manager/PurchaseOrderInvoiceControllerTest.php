...
test(
    ...
    function (): void {
        ...
        $purchaseOrderInvoiceQueries = $this->mock(PurchaseOrderInvoiceQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getByIdAndLocationForSent')
                ->once()
...
test(
    ...
    function (): void {
        ...
        $this->assertStringContainsString('store-manager/purchase-order-invoices', $response->getTargetUrl());
    }
);
...
test(
    ...
    function (): void {
        ...
        $purchaseOrderInvoiceQueries = $this->mock(PurchaseOrderInvoiceQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getByIdAndLocationForPaid')
                ->once()
                ->andReturn($purchaseOrderInvoice);
        });
...
test(
    ...
    function (): void {
        ...
        $purchaseOrderInvoiceQueries = $this->mock(PurchaseOrderInvoiceQueries::class, function ($mock) use (
            ...
            $mock->shouldReceive('getByIdAndLocation')
                ->once()
                ->andReturn($purchaseOrderInvoice);
        });
...
test(
    ...
    function (): void {
        ...
        $this->mock(PurchaseOrderInvoiceService::class, function ($mock) use ($fulfillments): void {
...
test(
    ...
    function (): void {
        ...
        $this->mock(PurchaseOrderFulfillmentQueries::class, function ($mock) use ($fulfillments): void {
            $mock->shouldReceive('getByIdLocationAndCompanyId')
                ->once()

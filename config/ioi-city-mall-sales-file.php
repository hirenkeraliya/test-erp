...
return [
    ...
    */
    ...
    |
    */
    'first_file_generation_date' => '2023-09-01',
    ...
    |
    */
    'enable_file_generation' => env('IOI_CITY_MALL_ENABLE_FILE_GENERATION', false),
    ...
    |
    */
    'enable_file_upload' => env('IOI_CITY_MALL_ENABLE_FILE_UPLOAD', false),
